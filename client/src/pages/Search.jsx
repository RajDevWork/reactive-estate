...
}, [location.search]);  // 👈 jab URL query change hoga tabhi chalega
  ...
  return (
    <div className='flex flex-col md:flex-row'>
        <div className='p-7 border-b-2 md:border-r-1 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                <div className='flex items-center gap-2'>
                    ...
                    <input type="text" className='border rounded-lg p-3 w-full bg-white' id="searchTerm" placeholder='Search...' value={sidebarData.searchTerm} onChange={handleChange}/>
                </div>
                ...
                <div className='flex gap-2 flex-wrap items-center'>
                    ...
                    <select name="sort_order" id="sort_order" className='border rounded-lg p-3 bg-white' onChange={handleChange}
        ...
        <div className='flex-1'>
            ...
            <div className='p-7 flex flex-wrap flex-row gap-4'>
            ...
            </div>
            {
                    showMore && (
                        <button
                            ...
                            className='text-green-700 hover:underline p-7 font-semibold w-full text-center'
